...
CREATE TABLE IF NOT EXISTS guardian_build_advisor_cache (
...
CREATE INDEX IF NOT EXISTS guardian_build_advisor_cache_expiry
  ON guardian_build_advisor_cache(expires_at);
