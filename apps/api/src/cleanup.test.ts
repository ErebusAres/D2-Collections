...
function database(observations: Array<{ metadata_json: string }> = [], cosmeticCache?: { choices_json: string; sets_json: string; refreshed_at: string }, timestamps = { recentItems: "2026-09-23T20:00:00.000Z", gear: "2026-09-23T20:01:00.000Z" }) {
