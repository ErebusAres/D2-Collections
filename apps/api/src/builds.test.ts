...
describe("build validation", () => {
  ...
  it("accepts unlisted visibility for link-only published builds", () => {
    expect(buildDocumentSchema.parse({ ...validBuild, status: "published", visibility: "unlisted" }).visibility).toBe("unlisted");
  });
