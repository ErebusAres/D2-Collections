...
const querySchema = z.object({
  kind: z.enum(["class", "subclass", "super", "classAbility", "movement", "melee", "grenade", "transcendence", "aspect", "fragment", "weapon", "weaponPerk", "armor", "armorTrait", "exoticSpirit", "armorMod", "armorSetBonus", "artifact", "artifactPerk", "champion", "cosmetic", "noteIcon", "icon"]),
