...
import { RecentEventRow, type LootItem, type WeaponSocketChange } from "./RecentLoot";
...
export function LootWorkspace({ timeline, loading = false, error, warnings = [], onRetry, onTag, onSocketChange, busy }: LootWorkspaceProps) {
  ...
  return <>
    ...
    <RecentEventRow title="Recent Weapons" subtitle="Physical weapon instances · newest to oldest" events={weapons} onTag={onTag} onSocketChange={onSocketChange} busy={busy} empty={`No recent weapons${emptySuffix}`} />
    <RecentEventRow title="Recent Armor" subtitle="Physical armor instances · newest to oldest" events={armor} onTag={onTag} onSocketChange={onSocketChange} busy={busy} empty={`No recent armor items${emptySuffix}`} />
    <RecentEventRow title="Recent Loot" subtitle="Catalysts, engrams, materials, and inventory gains · newest to oldest" events={loot} onTag={onTag} onSocketChange={onSocketChange} busy={busy} empty={`No catalysts, engrams, materials, or inventory gains${emptySuffix}`} />
