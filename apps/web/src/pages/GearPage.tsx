...
export function GearPage() {
  ...
  return <AuthGate><PageHeader eyebrow="Your account-wide gear" title="Gear" description={workspace === "weapons" ? "Compare every weapon roll, view all available traits, and see separate PvE and PvP ratings." : workspace === "loot" ? "Review your newest weapons, armor, catalysts, engrams, materials, and other items." : workspace === "vault" ? "Search and filter the weapons and armor currently stored in your Vault." : "Compare armor stats, see every modifier, and manage pieces across your characters and Vault."} actions={<><Freshness observedAt={result.data?.freshness.observedAt} warning={result.data?.warnings[0]} /><button className={styles.gearRefresh} onClick={refresh}><RefreshCw size={14} /> Sync gear</button></>} />
