...
[data-location-theme=orbit],.gn-fireteam-location[data-fireteam-location-theme=orbit]{--loc-line:#7998c48c;--loc-glow:#526d9d29;--loc-edge:#7897c31b;--loc-card:radial-gradient(circle,#dce9ff99 0 1px,transparent 2px) 0 0/57px 41px,radial-gradient(ellipse at 50% 125%,transparent 0 48%,#7897c345 49%,#17243a55 53%,transparent 54%);--loc-page:radial-gradient(circle,#fff 0 1px,transparent 2px) 0 0/83px 67px,radial-gradient(ellipse at 50% 112%,transparent 0 42%,#7897c32b 43%,#0d172a44 49%,transparent 50%);--loc-animation:gn-stars 14s linear infinite}
