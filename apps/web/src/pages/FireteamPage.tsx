...
[data-location-theme=orbit],.gn-fireteam-location[data-fireteam-location-theme=orbit]{--loc-line:#7998c48c;--loc-glow:#526d9d29;--loc-edge:#7897c31b;--loc-card:radial-gradient(circle at 7% 21%,#fff 0 .7px,transparent 1.5px),radial-gradient(circle at 12% 27%,#bcd5ff 0 1.5px,transparent 2.4px),radial-gradient(circle at 18% 17%,#fff 0 .9px,transparent 1.7px),radial-gradient(circle at 37% 36%,#dce9ff 0 1.1px,transparent 2px),radial-gradient(circle at 63% 13%,#fff 0 .7px,transparent 1.5px),radial-gradient(circle at 79% 31%,#afcfff 0 1.4px,transparent 2.4px),radial-gradient(circle at 91% 19%,#fff 0 .8px,transparent 1.6px),radial-gradient(ellipse at 29% 24%,#8facdb20,transparent 25%),radial-gradient(ellipse at 76% 32%,#759ad316,transparent 20%),radial-gradient(ellipse at 50% 125%,transparent 0 48%,#7897c345 49%,#17243a55 53%,transparent 54%);--loc-page:radial-gradient(circle at 3% 16%,#fff 0 .8px,transparent 1.6px),radial-gradient(circle at 8% 23%,#a9caff 0 1.5px,transparent 2.5px),radial-gradient(circle at 14% 12%,#fff 0 .6px,transparent 1.3px),radial-gradient(circle at 27% 38%,#dce9ff 0 1px,transparent 1.9px),radial-gradient(circle at 48% 17%,#fff 0 .7px,transparent 1.5px),radial-gradient(circle at 67% 29%,#b6d1ff 0 1.4px,transparent 2.3px),radial-gradient(circle at 73% 12%,#fff 0 .6px,transparent 1.4px),radial-gradient(circle at 88% 41%,#dce9ff 0 1.1px,transparent 2px),radial-gradient(circle at 96% 19%,#fff 0 .8px,transparent 1.6px),linear-gradient(126deg,transparent 18%,#6f8fbd0b 35%,#a9c5ec1b 43%,#6d89b50a 51%,transparent 67%),radial-gradient(ellipse at 11% 21%,#7897c31d,transparent 18%),radial-gradient(ellipse at 71% 26%,#7897c318,transparent 23%),radial-gradient(ellipse at 50% 112%,transparent 0 42%,#7897c32b 43%,#0d172a44 49%,transparent 50%);--loc-animation:gn-orbit-clusters 10s ease-in-out infinite alternate}
