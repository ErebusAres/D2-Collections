...
export function MatrixPage() {
  ...
  return <AuthGate>
    ...
    {selectedGuardians.length > 0 && <>
      ...
      {selectedSnapshots.length === 0 ? <div className={styles.inlineEmpty}><GitCompareArrows /><h2>Selected Matrix awaiting sync</h2><p>Use “Sync my Matrix” to publish your snapshot.</p></div> : <>
