...
vi.mock("../services/api/client", () => ({ getLastServiceIncident: vi.fn(() => undefined), describeApiError: vi.fn((error: Error) => error.message), getClientReliabilityDiagnostics: vi.fn(() => undefined), getLastApiErrorDiagnostics: vi.fn(() => undefined), api: vi.fn(async () => ({ data: {
  reportVersion: 1,
