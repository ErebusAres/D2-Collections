...
import { Check, ClipboardCopy, Compass, Download, FilePenLine, LayoutGrid, Link as LinkIcon, ListTree, Share2 } from "lucide-react";
  ...
  return <>
    ...
    {build && <>
      ...
      <section className={styles.buildHero}>
        ...
        <BuildRating buildId={build.id} rating={build.rating} viewerVote={build.viewerVote} disabled={build.status !== "published" || build.canVote === false} onChange={ratingChanged} />
      </section>
