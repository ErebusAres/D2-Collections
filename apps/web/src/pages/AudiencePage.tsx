  ...
  return <AuthGate>
    ...
    {data && <>
      ...
      <section className={styles.panel}>
        ...
        <div className={styles.tableWrap}><table><thead><tr><th>Guardian</th><th>Membership ID</th><th>Class</th><th>Power</th><th>Rank / Pass</th><th>First login</th><th title="Most recent authenticated site request; recorded at most once every five minutes. Background jobs do not count.">Last seen</th><th>Sessions</th><th>Admin action</th></tr></thead><tbody>
          {data.logins.map((row) => {
