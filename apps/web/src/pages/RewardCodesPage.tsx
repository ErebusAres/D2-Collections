...
export function RewardCodesPage() {
  ...
  return <>
    ...
    <section className={styles.summary}><div><Gift /><span>Unredeemed active</span><strong>{unredeemedActive.length}</strong></div><div><ShieldCheck /><span>Detected in Collections</span><strong>{catalogDetectedCount}</strong></div><div><CheckCircle2 /><span>Manually marked</span><strong>{catalogManualCount}</strong></div><div><Clock3 /><span>Last catalog verification</span><strong>July 11, 2026</strong></div></section>
