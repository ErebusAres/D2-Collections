  ...
  return <>
    ...
    {result.data && <>
      <section className={styles.buildCommandBar}>
        ...
        <label><span>Includes</span><select value={filters.feature} onChange={(event) => update("feature", event.target.value as BuildFilters["feature"])}><option value="all">Any content</option><option value="dim">DIM link</option><option value="video">Video link</option><option value="notes">Field notes</option></select></label>
