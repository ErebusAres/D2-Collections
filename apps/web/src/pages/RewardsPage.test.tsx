...
describe("RewardLevelColumn", () => {
  ...
  it("renders post-100 pips as progress into the next reward rank", () => {
    const current = render(<RewardLevelColumn entry={{ level: 101, rewards: [] }} currentRank={101} currentRankSegments={[100, 100, 100, 100, 0]} />);
    expect(current.getByLabelText("Rank 101 post-100 pips: 5 of 5 filled")).toBeTruthy();
    ...
    expect(next.getByLabelText("Rank 102 post-100 pips: 4 of 5 filled")).toBeTruthy();
  });
});
