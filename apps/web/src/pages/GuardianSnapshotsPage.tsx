...
function SnapshotManager() {
  ...
  return <>
    <PageHeader eyebrow="Optional link sharing" title="Guardian share cards" description="Make a small profile card for a Fireteam or friend. You choose exactly what it says; it is not a backup or live snapshot of your account." />
    <section className={styles.explainer}><IdCard /><div><strong>What this is for</strong><p>Create a private card for yourself, or an unlisted link showing selected details such as class, Guardian Rank, role, goals, and one public build. Nothing is shared until you choose Unlisted and send its link.</p></div></section>
