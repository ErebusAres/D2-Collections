...
function SnapshotManager() {
  ...
  return <>
    <PageHeader eyebrow="Legacy account data" title="Retired share cards" description="New cards can no longer be created. Existing cards remain here only so you can review, copy, or revoke them." actions={<><Link to="/builds">Share a build</Link><Link to="/fireteam">Fireteam readiness</Link></>} />
    <section className={styles.explainer}><IdCard /><div><strong>This feature has been retired</strong><p>Share Cards duplicated public Builds and Fireteam readiness while requiring a manually maintained profile. Existing private data and unlisted links are preserved until you revoke them.</p></div></section>
