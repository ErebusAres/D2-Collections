...
- Current implementation branch: `codex/recent-loot-tier-diamonds`. It centralizes Destiny tier mapping and adds the shared diamond to physical weapons, armor, catalysts, Exotic Engrams, materials, and miscellaneous inventory cards in both Fireteam and Gear history.
