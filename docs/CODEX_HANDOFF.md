...
- Current implementation branch: `codex/real-gear-tiers-partial-ratings`. The correction is fully audited locally; PR, deployment, and signed-in production verification are pending.
